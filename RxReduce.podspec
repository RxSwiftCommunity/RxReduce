Pod::Spec.new do |s|
  ...
  s.name         = "RxReduce"
  s.version      = "0.2.0"
  s.summary      = "RxReduce is a lightweight framework that ease the implementation of a Redux like pattern in a Reactive Programming compliant way."
...
* Type safe Reducers
* An elegant way to deal with side effects outside Reducers
                   DESC
